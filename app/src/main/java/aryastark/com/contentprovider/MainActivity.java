package aryastark.com.contentprovider;
...
//        });
    ...
    public void addRecord(View view) {
        ...
        if ((!((EditText) findViewById(R.id.name)).getText().toString().isEmpty()) && (!((EditText) findViewById(R.id.nickname)).getText().toString().isEmpty())) {
    ...
    public void showAllRecords(View view) {
        ...
        if (!c.moveToFirst()) {
            ...
            do {
                result = result + "\n" + c.getString(c.getColumnIndex(CustomContentProvider.NAME)) + " has nickname: " + c.getString(c.getColumnIndex(CustomContentProvider.NICK_NAME));
            } while (c.moveToNext());
            if (!result.isEmpty())
